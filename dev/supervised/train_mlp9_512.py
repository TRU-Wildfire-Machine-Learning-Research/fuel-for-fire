...
from Utils.Model import LayersMultiLayerPerceptron9_512
...
if __name__ == "__main__":
    ...
    mlpmodel = LayersMultiLayerPerceptron9_512(X_test_centered.shape[1], 6, learning_rate=0.0333)

    sess = tf.Session(graph=mlpmodel.g)
    training_costs = LayersMultiLayerPerceptron9_512.train_mlp(sess,
                                                    mlpmodel,
                                                    X_train_centered,
                                                    y_train,
                                                    num_epochs=1000,
    ...
    y_pred = LayersMultiLayerPerceptron9_512.predict_mlp(sess, mlpmodel, X_test_centered)
